...
@section('content')
	<div class="container">
            <div class="panel panel-primary">
                    <div class="panel-heading"> Appoinment Details</div>
                        ...
                        <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Assign to other Closer</button>
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">No show</button>
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Reschedule</button>
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Call complete</button>
