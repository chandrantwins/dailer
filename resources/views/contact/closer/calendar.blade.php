...
<div class="row">
	<div class="panel panel-primary">
		<div class="panel-heading">Closer Timezoness</div>
		<div class="panel-body">
			{!! Form::open(array('route'=>['contact.closerpostcalendar',$contact->id,$appointment->id],'method'=>'POST','files'=>true)) !!}
				<div class="row">
...
<div class="modal fade" tabindex="-1" role="dialog" id="eventmodal{{str_random(6)}}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('appointment.closerinformation')}}" method="post" id="appointmentinformation_form" name="{{$contact->id}}">
                <div class="form-group">
